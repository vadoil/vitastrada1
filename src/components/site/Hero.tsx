export const Hero = () => {
  return (
    <section id="top" className="relative h-[100svh] w-full overflow-hidden bg-ink noise">
      {/* Video background */}
      <video
        ...
        loop
        playsInline
        poster="https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=1920&q=80"
      >
        <source
          src="https://cdn.pixabay.com/video/2024/03/15/204172-924698132_large.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div className="relative z-10 container-editorial h-full flex flex-col justify-end pb-20 md:pb-28">
        <div className="grid grid-cols-12 gap-6 items-end">
          ...
          <div className="col-span-12 md:col-span-8">
            <div className="overflow-hidden">
              <div className="text-overline text-bone-dim mb-6 md:mb-10 animate-fade-up">
          ...
          <div className="col-span-12 md:col-span-2 md:text-right">
            <div className="text-overline text-bone-dim animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <span className="block">№ 001</span>
              <span className="block mt-1 text-bone/40">Atelier</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 md:mt-20 grid grid-cols-12 gap-6 items-end">
          ...
          <div className="col-span-12 md:col-span-5 md:col-start-8 flex items-center gap-6 animate-fade-up" style={{ animationDelay: "0.85s" }}>
            <a
              href="#contact"
              className="group inline-flex items-center gap-4 bg-bone text-ink px-8 py-5 text-overline hover:bg-gold transition-colors duration-500"
            >
              Оставить заявку
