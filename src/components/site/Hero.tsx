        ...
        <div className="mt-auto pb-14 md:pb-20 grid grid-cols-12 gap-6 items-end">
          <div className="col-span-12 md:col-span-8 lg:col-span-9">
            ...
            <div className="mt-10 md:mt-14 grid grid-cols-12 gap-6 items-end">
              ...
              >
                Полный цикл: лекало, образец, отшив, контроль качества, отгрузка. Партии от 30 единиц. Премиальные ткани. Сложные конструкции. Личный технолог. Отдельное направление — couture-одежда для собак.
              </motion.p>
